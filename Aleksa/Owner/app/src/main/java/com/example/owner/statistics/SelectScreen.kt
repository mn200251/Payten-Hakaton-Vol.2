    ...
    Column(
        ...
        Row(
            ...
            OutlinedButton(
                ...
                Text(text = snippetDestinations[1].route, style = buttonTextStyle)
            }
            OutlinedButton(
                modifier = Modifier
                    .padding(5.dp)
                ...
                Text(text = snippetDestinations[2].route, style = buttonTextStyle)
            }
        }
        Row(
            Modifier
            ...
            OutlinedButton(
                ...
                Text(text = snippetDestinations[3].route, style = buttonTextStyle)
            }
            OutlinedButton(
                modifier = Modifier
                    .padding(5.dp)
                ...
                Text(text = snippetDestinations[4].route, style = buttonTextStyle)
            }
        }
        Row(
            Modifier
            ...
            OutlinedButton(
                ...
                Text(text = snippetDestinations[5].route, style = buttonTextStyle)
            }
            OutlinedButton(
                modifier = Modifier
                    .padding(5.dp)
                ...
                Text(text = snippetDestinations[6].route, style = buttonTextStyle)
            }
        }
    }
